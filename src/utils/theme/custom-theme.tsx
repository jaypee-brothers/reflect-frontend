const customTheme = {
  ...
  drawer: {
    ...
    header: {
      inner: {
        ...
        closeIcon: 'h-4 w-4',
        titleText: 'mb-4 inline-flex items-center text-base font-semibold text-bodytext',
      },
    },
  },
  ...
  modal: {
    ...
    content: {
      ...
      inner: 'relative flex max-h-[90dvh] flex-col rounded-md bg-white dark:bg-darkgray',
    },
    sizes: {
      sm: 'max-w-sm',
      md: 'max-w-md',
    ...
    header: {
      ...
      close: {
        base: 'ltr:ml-auto rtl:mr-auto items-center rounded-md bg-transparent p-1.5 text-sm text-gray-400 hover:bg-gray-200 hover:text-gray-900 dark:hover:bg-gray-600 dark:hover:text-white',
        icon: 'h-5 w-5',
      },
    },
    footer: {
  ...
  sidebar: {
    ...
    item: {
      base: 'flex items-center justify-center rounded-md px-4 py-3 mb-1 gap-3 text-[15px] leading-[normal] font-normal text-link  hover:text-primary dark:text-white  dark:hover:text-primary',
      content: {
    ...
    collapse: {
      button:
        'group flex gap-3 items-center  rounded-md px-4 py-3 mb-1 text-[15px] leading-[normal] font-normal text-link  hover:text-primary dark:text-white w-full dark:hover:text-primary',
      icon: {
