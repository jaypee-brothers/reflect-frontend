...
const CustomCollapse: React.FC<{
  ...
  return (
    <div className={twMerge('transition-all duration-300')}>
      <div
        className={twMerge(
          'flex cursor-pointer mb-1 items-center justify-between rounded-md px-4 py-[11px] gap-3 text-[15px] leading-[normal] font-normal text-link nav-cover hover:text-primary dark:text-white  dark:hover:text-primary',
          className,
        )}
        onClick={onClick}
      >
